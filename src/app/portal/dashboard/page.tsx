...
export default async function Dashboard() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-14">
      ...
      <h1 className="font-display text-3xl font-bold text-teal mt-1">{ssa.name}</h1>
      {ssa.status === 'live' ? (
      ...
      <div className="mt-10 rounded-2xl bg-gold/20 p-6">
        ...
        <p className="text-sm text-teal-ink/70 mt-1">Funding templates, event playbooks, and chapter guides.</p>
