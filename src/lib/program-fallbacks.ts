...
export const programFallbacks: Program[] = [
  // ── Sikhi Development ──
  {
    ...
    tagline: 'Put the phone down. Come back to yourself.',
    body: 'An annual Sikhi retreat out in nature. You unplug from everything else and reconnect with Gurmat through nitnem, kirtan, workshops, and sangat. For a lot of students it is the first time being fully Sikh in a room where everyone else feels the same way.',
  ...
  },
  {
    ...
    body: 'Gurmat study that goes past translation into an actual relationship with Bani. Our 10-week Gurmat Sangeet course is now an official UC Davis offering — 250+ attendees in Fall 2025, and a second UC campus joining in Fall 2026.',
  ...
  },
  {
    ...
    pillar: 'Sikhi Development',
    tagline: "Guru Teg Bahadur Ji's teachings — taught by people your age.",
    body: "Working with Sikh Dharmsal, we trained 6 youth facilitators to lead workshops on Guru Teg Bahadur Ji's Salok Mahala 9 — so the person teaching you is someone who gets where you are. The series is expanding to SSAs across the West Coast.",
  ...
  },
  {
    ...
    body: 'LSAT prep, free, taught by Sikhs who scored in the 97th percentile and above — so you are not paying thousands for a course or figuring it out alone. Launching May 2026 with the Sikh Legal Society. MCAT and DAT prep are next.',
  ...
  },
  {
    ...
    pillar: 'SSA Network',
    tagline: 'For the board members holding it all together.',
    body: 'Annual retreats for SSA board members across the West Coast, Midwest, and East Coast — come recharge, swap what is working, and head back with a plan. This year: 65+ participants from 18 SSAs, and 95% felt more confident leading their chapter afterward.',
  ...
  },
  {
    ...
    body: '120+ board members connected coast to coast. Ask a question, borrow a playbook, or find out how another chapter pulled something off — in real time, from people who have done it.',
  ...
  },
  {
    ...
    title: 'Advocacy',
    pillar: 'SSA Network',
    tagline: 'When something happens, you are not on your own.',
    body: 'After the SJSU hate crime, USM mobilized West Coast schools toward Sikh awareness trainings with UC and CSU administrators and university police — so chapters had backing instead of having to fight it alone.',
  ...
  },
  {
    ...
    body: 'A student-led initiative that sends diaspora youth to Punjab. You listen to village leaders, families, and educators first — then help build projects that outlast the trip. Community-informed, student-driven, and what it looks like when Gurmat meets real seva.',
